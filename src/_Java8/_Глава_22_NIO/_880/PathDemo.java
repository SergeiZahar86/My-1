package _Java8._Глава_22_NIO._880;
...
class PathDemo {
    public static void main (String args[]) {
        Path filepath = Paths.get("C://Users/serge/" +
                "IdeaProjects/На ноуте учёба/test.txt");
        ...
        try {
            ...
            if (attribs.isSymbolicLink())
                ...
                System.out.println("The file is not a symbolic " +
                        "link");
            System.out.println("File last modified: " + attribs.
                    lastModifiedTime());
