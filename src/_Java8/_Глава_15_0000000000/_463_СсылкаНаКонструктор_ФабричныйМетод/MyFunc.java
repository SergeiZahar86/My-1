package _Java8._Глава_15_0000000000._463_СсылкаНаКонструктор_ФабричныйМетод;
...
class ConstructorRefDemo3 {
    ...
    // У каждого класса должен быть свой
    // конструктор , принимающий один параметр типа
    // Т. А параметр R обозначает тип
    ...
    public static void main (String[] args) {
        ...
        MyClass <Double> mc = myClassFactory(myClassCons,
                100.1);
        System.out.println("Значение val в объекте mc " +
                "равно " + mc.getVal());
